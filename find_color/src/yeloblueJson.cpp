...
int main(int argc, char** argv){
	...
	if ( argc == 2 ) {
		if(atoi(argv[1]) == 1)
			...
			cout << "Error param." << endl << "  Use : " << argv[0] << " [1 (DrawContours)]" << endl;
			return 1;
		}
	}
	cout << "DrawContours = "<<  DrawContours << endl;
	
	ros::init(argc, argv, "yeloblueJson");
	ros::NodeHandle n;
	ros::Publisher chatter_pub = n.advertise<std_msgs::String>("yeloblueJson", 2);
